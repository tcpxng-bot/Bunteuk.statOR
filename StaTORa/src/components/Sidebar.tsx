...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:w-[260px] flex-col bg-white border-r border-gray-100 h-screen sticky top-0">
      {/* Logo */}
          ...
          if (item.children) {
            ...
            return (
              <div key={item.label}>
                ...
                >
                  <span className={childActive ? "text-teal-600" : "text-gray-400"}>
                    {item.icon}
                  </span>
                      ...
                      return (
                        <button
                          ...
                          className={`block w-full text-left rounded-md px-3 py-2 text-sm transition-colors ${
                            childIsActive
                              ? "text-teal-700 bg-teal-50/60 font-medium"
      ...
      <div className="border-t border-gray-100 px-4 py-4">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-teal-100 text-teal-700 text-sm font-medium shrink-0">
      ...
      <div className="flex items-center justify-around py-1.5">
        {mobileItems.map((item) => {
          ...
          return (
            ...
            >
              {item.icon === "plus" ? (
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-teal-600 text-white -mt-4 shadow-lg shadow-teal-600/30">
                  {icons[item.icon]}
                </div>
              ) : (
                icons[item.icon]
